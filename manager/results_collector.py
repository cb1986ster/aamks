...
# }}}
        def psql_report(self):
            ...
            p.query("UPDATE simulations SET i_risk = '{}' WHERE project=%s AND scenario_id=%s AND iteration=%s".format(self.meta['psql']['i_risk']), (self.meta['project_id'], self.meta['scenario_id'], self.meta['sim_id']))
    try:
        host=sys.argv[1]
