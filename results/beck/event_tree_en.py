...
class EventTreeFED:
    ...
    def __init__(self, building, p_general, p_develop, p_dcbe, p_fed_n, p_fed_l, p_fed_m, p_fed_f, mode):
    ...
    def draw_tree(self):
        ...
        head = ['Ignition', 'Early suppression', 'ASET > RSET', '{}|FED'.format(c_type)]
        ...
        ax.text(0.5 * 1.54, 0.5 * 1.7, 'Probability', horizontalalignment='center', verticalalignment='center',
        ...
        suppressed = [[1.1, 4.4], [0.5, 0.5], 'P = {}'.format(1 - self.p_develop)]
        ...
        dcbe = [[2.2, 4.4], [0.3, 0.3], 'P = {}'.format('%.3f' % (1 - float(self.p_dcbe)))]
        ...
        fed_n = [[3.3, 4.4], [0.115, 0.115], 'P = {}'.format('%.3f' % (1 - fed))]
        ax.plot(fed_n[0], fed_n[1], linewidth=2, color='g')
        ax.text(3.5, 0.135, 'NO')
        ax.text(3.5, 0.070, fed_n[2])
        ...
        fig.savefig('{}/picts/tree_{}.png'.format(self.building, self.mode))
